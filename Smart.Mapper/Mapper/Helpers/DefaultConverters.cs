...
internal static class DefaultConverters
{
    ...
    public static Dictionary<Tuple<Type, Type>, ConverterEntry> Entries => new()
    {
        ...
        { new(typeof(string), typeof(char)), new(ConverterType.FuncSource, typeof(string), typeof(char), (Func<string, char>)(x => x[0])) },
        ...
        // String
        { new(typeof(char[]), typeof(string)), new(ConverterType.FuncSource, typeof(char[]), typeof(string), (Func<char[], string>)(x => new string(x))) },
        { new(typeof(string), typeof(char[])), new(ConverterType.FuncSource, typeof(string), typeof(char[]), (Func<string, char[]>)(x => x.ToCharArray())) },
        // DateTime
        ...
        { new(typeof(string), typeof(DateTimeOffset)), new(ConverterType.FuncSource, typeof(string), typeof(DateTimeOffset), (Func<string, DateTimeOffset>)(x => DateTime.Parse(x))) },

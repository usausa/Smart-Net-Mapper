...
internal sealed class EmitHolderInfo
{
    ...
    {
        var argumentTypes = String.IsNullOrEmpty(member.NestedProfile) ? Type.EmptyTypes : [typeof(string)];
        ...
        return genericMethod.Invoke(context.NestedMapper, argumentTypes.Length == 0 ? null : [member.NestedProfile])!;
    }
